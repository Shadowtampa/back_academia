...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Editando {{$treino->title}}'])
            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <form class="pb-0 mt-4 mx-4" method="PUT" action="{{ '/training-update' }}">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="Treino A" value="{{$treino->title}}" />
                                    </div>
                                </div>
                                    ...
                                    @foreach ($diasDaSemana as $dia)
                                        <div class="form-check mb-3">
                                            ...
                                            <input class="form-check-input" type="radio" name="dayOfTheWeek"
                                                id="{{ $dia }}" value="{{ $dia }}"
                                                onclick="updateDiaSemana(this)"  {{ $treino->dayOfTheWeek == $dia ? 'checked' : '' }}> 
                            ...
                            <button type="submit" class="btn bg-gradient-success btn-sm pull-end">Atualizar Treino</button>
